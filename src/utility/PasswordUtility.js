...
const GenerateSignature = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    return yield jsonwebtoken_1.default.sign(payload, config_1.APP_SECRATE, { expiresIn: '10h' });
});
...
const validateSignature = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!signature)
        return false;
    try {
        req.user = (yield jsonwebtoken_1.default.verify(signature.split(' ')[1], config_1.APP_SECRATE));
        return true;
    }
    catch (error) {
